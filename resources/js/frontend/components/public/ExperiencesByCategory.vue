                ...
                <div class="container">
                    ...
                    <div class="features__Exp--content">
                       ...
                       <div class="row cst__Row" v-show="isShowingLoader">
                        ...
                        <div class="row cst__Row"> 
                            <div v-if="experiences.length" v-for="(experience,key) in experiences" class="col-xs-6 col-sm-6 col-md-4 col-lg-3 cst__Col">
                            ...
                            <div v-if="!experiences.length" class="col-sm-12">
                                <div class="no-experiences-found">
                                    <div class="no-exp-found-head">
                                        <span>No experiences found  for <b>{{ category_name }}</b> ,browse all other experiences</span>
                                    </div>
                                    <div class="browse_all-btn">
                                        <router-link :to="{ name : 'experiences_list'}" class="browse_all exp__Btn--outline">Browse
                                            All <i class="fa fa-angle-right" aria-hidden="true"></i>
                                        </router-link>
                                    </div>
                                </div>
                            </div> 
...
export default {
    ...
    methods: { 
        getExperiencesList(){ 
          ...
          this.$store.dispatch('getAllExperiencesByCategory',{ category_name : category_name  })
